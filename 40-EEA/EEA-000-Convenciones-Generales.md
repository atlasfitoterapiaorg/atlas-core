...
Este documento establece las convenciones generales que deberán seguir todos los documentos, repositorios y componentes del Atlas de Fitoterapia.
...
Las reglas aquí definidas constituyen el estándar base sobre el cual se desarrollan los demás Estándares de Ejecución del Atlas (EEA).
...
Su cumplimiento es obligatorio para todas las contribuciones que formen parte del repositorio oficial.
...
- decisiones que le dieron origen;
...
Cada documento deberá abordar un único propósito claramente definido.
...
La información oficial deberá existir en un único lugar.


Cuando un contenido sea necesario en varios documentos, éstos deberán referenciar la fuente oficial en lugar de duplicarla.
...
Todos los documentos deberán seguir la plantilla oficial correspondiente a su categoría documental.
...
Las modificaciones deberán preservar la compatibilidad con la arquitectura vigente.


Los cambios que afecten decisiones previamente aprobadas deberán seguir el proceso de gobernanza correspondiente.
...
Las convenciones podrán evolucionar conforme crezca el Atlas.
...
El cumplimiento de este estándar será obligatorio para todos los activos incorporados al repositorio oficial del Atlas.


Los documentos que no cumplan con estas convenciones deberán corregirse antes de ser considerados aprobados.


Siempre que sea técnicamente posible, el cumplimiento deberá verificarse mediante herramientas automatizadas.
