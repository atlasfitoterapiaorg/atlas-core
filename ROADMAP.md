...
> Documento vivo que define la planificación estratégica y operativa del proyecto **Atlas de Fitoterapia**. Es la única fuente oficial para conocer el estado del proyecto, los entregables, los sprints activos y el backlog de propuestas.
...
# Release v0.3 — Infraestructura

## Objetivo

Implementar la infraestructura tecnológica del Atlas.
...
Diseñar el modelo conceptual del Atlas.
...
Crear las primeras monografías científicas completas.
...
Publicar la primera versión oficial del Atlas.
